...
OPERATOR_PROTOTYPES: Dict[str, Tuple[str, ...]] = {
    ...
    "mean_median_gap": (
        ...
        "Absolute gap between average and median contract size unless subtraction order is explicit.",
    ),
    "avg_work_size": (
    ...
    "doc_filtered_aggregate": (
        "Money sum of a client's projects restricted to an evidenced performance assessment grade.",
        "Aggregate completed works assessed as Good, Very Good, Excellent, Satisfactory, or Outstanding.",
    ),
    "temporal_chain": (
